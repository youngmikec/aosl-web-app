                ...
                <div className='w-full border-b-2 border-[#7f7f8056] py-5 px-5'>
                    <div className='flex justify-start'>
                        ...
                        <div className='mx-3 my-auto'>
                            <button 
                                className='hover:bg-[#042f9c] border-2 border-[#042f9c]
                                text-[#042f9c] hover:text-white rounded-md py-1 px-6'
                                onClick={() => openFile()}
                            >
                                Upload
                            </button>
                        ...
                        {/* <div className='mx-3 my-auto'>
                            <button className='text-[#042f9c] border-2 border-[#042f9c] rounded-md py-1 px-6'>
                                Upload
                            </button>
                        </div> */}
                        <div></div>
